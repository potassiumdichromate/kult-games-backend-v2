...
export const config = {
  ...
  db: {
    ...
    col: {
      ...
      momentBookmarks:    e('MOMENT_BOOKMARKS_COLL',         'moment_bookmarks'),
      momentWatchHistory: e('MOMENT_WATCH_HISTORY_COLL',     'moment_watch_history'),
